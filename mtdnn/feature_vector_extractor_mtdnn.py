...
from mtdnn.dataset_mtdnn import MTDNNCollater, MTDNNSingleTaskDataset
...
def main():
    ...
    MTDNNCommonUtils.set_environment(args.seed)
    # process data
    ...
    collater = MTDNNCollater(is_train=False, encoder_type=encoder_type)
    dataset = MTDNNSingleTaskDataset(
